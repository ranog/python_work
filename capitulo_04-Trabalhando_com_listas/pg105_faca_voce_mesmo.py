...
DESCRIÇÃO
    ...
    básicos de comida. Pense em cinco pratos simples e armazene-os em uma
    tupla.
...
pratos = ('café colonial', 'comidas típicas das festas de são joão', 'carne\
de sol maracaípe', 'camarão havaiano maracaípe', 'torresmim')
...
pratos = ('café colonial', 'empadão', 'carne de sol maracaípe', 'dormência',\
'torresmim')
