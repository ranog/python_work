...
------------------------------------------------------------------------
    ...
    No laço criamos o dicionário plot_dict para cada projeto.
    Armazenamos o número de estrelas com a chave 'value' e a descrição
    do projeto com a chave 'label' em cada plot_dict. Então concatenamos
    o plot_dict de cada projeto em plot_dicts. Passamos a lista
    plot_dicts para add() .
